...
% The average coordinates distances over time in the Steps task with different Kinect placements shows rapid changes during time intervals when the partcipants take a step to a new position (See Figure~\subref*{steps_coordinates_over_time}).
