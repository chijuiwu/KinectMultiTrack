...
When the Kinect placements are averaged, the best case is $7.29$ cm (Stationary), the worst case is $20.07$ cm (Walk), and the average case is $14.10$ cm. When the tasks are averaged, the best case is $6.85$ cm (Parallel), the worst case is $22.97$ cm (90$^{\circ}$), and the average case is $10.57$ cm (See Table~\ref{table:results_three_coordinates_values}).
...
\begin{figure}[!h]
  ...
  \subfloat[Average coordinates distances in the Stationary, Steps, and Walk tasks averaged over Parallel, 45$^{\circ}$ and 90$^{\circ}$ apart Kinects.]{
    ...
    \label{fig:results_coordinates_kinect_all}
  ...
  \subfloat[Average joints distances in the Stationary, Steps, and Walk tasks averaged over Parallel, 45$^{\circ}$ and 90$^{\circ}$ apart Kinects.]{
    ...
    \label{fig:results_joints_kinect_all}
    ...
    \label{fig:results_coordinates_task_all}
  ...
  \subfloat[Average joints distances with Parallel, 45$^{\circ}$ and 90$^{\circ}$ apart Kinects averaged over Stationary, Steps, and Walk tasks.]{
    ...
    \label{fig:results_joints_task_all}
...
Figure~\ref{fig:results_three_coordinates_over_time} shows the average joints distances over time in the Stationary, Steps, and Walk tasks with Parallel, 45$^{\circ}$ and 90$^{\circ}$ apart Kinects. These figures demonstrate the stability of the tracking algorithm for different joints over time when performing different tasks in different Kinect placements. The figures are taken from participant 18.

% The average coordinates distances over time in the Steps task with different Kinect placements shows rapid changes during time intervals when the participants take a step to a new position (See Figure~\subref*{steps_coordinates_over_time}).

\begin{figure}[!h]
  \centering

  \subfloat[Stationary]{
    \includegraphics[width=0.33\linewidth]{figs/Participant_19_Task_Stationary_Kinect_Parallel_coordinates_over_time} 
    \includegraphics[width=0.33\linewidth]{figs/Participant_19_Task_Stationary_Kinect_45_coordinates_over_time}
    \includegraphics[width=0.33\linewidth]{figs/Participant_19_Task_Stationary_Kinect_90_coordinates_over_time}
    \label{fig:stationary_coordinates_over_time}
  } \\
  \subfloat[Steps]{
    \includegraphics[width=0.33\linewidth]{figs/Participant_19_Task_Steps_Kinect_Parallel_coordinates_over_time} 
  ...
  \subfloat[Walk]{
    \includegraphics[width=0.33\linewidth]{figs/Participant_19_Task_Walk_Kinect_Parallel_coordinates_over_time} 
    \includegraphics[width=0.33\linewidth]{figs/Participant_19_Task_Walk_Kinect_45_coordinates_over_time}
    \includegraphics[width=0.33\linewidth]{figs/Participant_19_Task_Walk_Kinect_90_coordinates_over_time}
    \label{fig:walk_coordinates_over_time}
  }
...
\begin{figure}[!h]
  ...
  \subfloat[Stationary]{
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Stationary_Kinect_Parallel} 
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Stationary_Kinect_45}
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Stationary_Kinect_90}
  } \\
  \subfloat[Steps]{
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Steps_Kinect_Parallel} 
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Steps_Kinect_45}
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Steps_Kinect_90}
  } \\
  \subfloat[Walk]{
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Walk_Kinect_Parallel} 
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Walk_Kinect_45}
    \includegraphics[width=0.33\columnwidth]{figs/Participant_19_Task_Walk_Kinect_90}
  }
...
\begin{figure}[!h]
  ...
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_1}
  }{1}
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_2}
  }{2}
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_3}
  }{3} \\
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_4}
  }{4}
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_5}
  }{5}
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_6}
  }{6} \\
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_7}
  }{7}
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_8}
  }{8}
  \stackunder[5pt]{
    \includegraphics[width=0.30\linewidth]{figs/obstacle_9}
  }{9}
...
\begin{figure}[!h]
  ...
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/interaction_1}
  }{1}
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/interaction_2}
  }{2}
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/interaction_3}
  }{3} \\
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/interaction_4}
  }{4}
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/interaction_5}
  }{5}
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/interaction_6}
  }{6} \\
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/interaction_7}
  }{7}
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/interaction_8}
  }{8}
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/empty}
  }{}
...
\begin{figure}[!h]
  ...
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/swap_1}
  }{1}
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/swap_2}
  }{2}
  \stackunder[5pt]{
    \includegraphics[width=0.20\linewidth]{figs/swap_3}
  }{3}
