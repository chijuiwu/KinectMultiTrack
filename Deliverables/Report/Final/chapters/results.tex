...
When the tasks are averaged, the best case is $6.85$ cm (Parallel), the worst case is $22.97$ cm (90$^{\circ}$), and the average case is $10.57$ cm.
...
\begin{figure}[!h]
  ...
  \subfloat{
    \includegraphics[width=0.33\linewidth]{figs/obstacle_1}
    \includegraphics[width=0.33\linewidth]{figs/obstacle_2}
    \includegraphics[width=0.33\linewidth]{figs/obstacle_3}
  } \\
  \subfloat{
    \includegraphics[width=0.33\linewidth]{figs/obstacle_4}
    \includegraphics[width=0.33\linewidth]{figs/obstacle_5}
    \includegraphics[width=0.33\linewidth]{figs/obstacle_6}
  } \\
  \subfloat{
    \includegraphics[width=0.33\linewidth]{figs/obstacle_7}
