...
\begin{figure}[!h]
  ...
  \caption{The user interface showing both the tracking and disjoined views when the same person stands in different positions, from both the front-facing and side-facing Kinects' perspectives}
