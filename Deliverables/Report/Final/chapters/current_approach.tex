...
{\centering
  Run ``\\KinectMultiTrack\\KinectMultiTrack\\MultiTrackServer\\bin\\Release\\KinectMultiTrack.\\exe [port]''
}
...
{\centering
  Run ``\\KinectMultiTrack\\KinectMultiTrack\\MultiTrackClient\\bin\\Release\\MultiTrackClient.\\exe [address] [port]''
}
