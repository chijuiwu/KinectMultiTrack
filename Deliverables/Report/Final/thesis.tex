...
The current work is about tracking people with multiple Kinects in occluded environments. The final submission contains an interactive software which demonstrates the tracking algorithm. This report describes the current approach and a series of user studies intended to evaluate the efficacy of the proposed system. The studies show that the current system can reliably track people under occlusion within the region of personal space. Future work can incorporate the tracking algorithm to enhance interactive experience.
