function [] = plotJointsStepsTask(joints_average_study_table, joints_average_scenario_table)
% 
...
plot_colors;
% 
% title_format = 'Joints Averages for the Steps Task, with %s Kinects';
% dir = 'Plots/Overall/';
% filename_format = strcat(dir,'Joints_Steps_Task_KinectConfig_%s');
% 
% first_avg_dx = 4;
% first_avg_dy = 6;
% first_avg_dz = 8;
...
title_format = 'Joints Averages for the Steps Task, with All Kinect Configurations';
dir = 'Plots/Overall/';
filename_format = strcat(dir,'Joints_Steps_Task_KinectConfig_All');
