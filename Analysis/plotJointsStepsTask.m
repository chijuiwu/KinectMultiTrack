function [] = plotJointsStepsTask(joints_average_scenario_table)
% 
% joint types over joints averages for steps task over all kinect
% configurations
...
title_format = 'Joints Averages in the Steps Task averaged over \n Parallel, 45%c and 90%c apart Kinects';
